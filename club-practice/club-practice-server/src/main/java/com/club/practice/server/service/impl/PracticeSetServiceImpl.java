...
import com.club.practice.api.common.PageResult;
...
import com.club.practice.api.req.GetPracticeSubjectsReq;
import com.club.practice.api.req.GetUnCompletePracticeReq;
import com.club.practice.api.vo.*;
import com.club.practice.server.dao.*;
import com.club.practice.server.entity.dto.CategoryDTO;
import com.club.practice.server.entity.dto.PracticeSetDTO;
import com.club.practice.server.entity.dto.PracticeSubjectDTO;
import com.club.practice.server.entity.po.*;
import com.club.practice.server.service.PracticeSetService;
...
public class PracticeSetServiceImpl implements PracticeSetService {
    ...
    public PracticeSetVO addPractice(PracticeSubjectDTO dto) {
        ...
        practiceSetPO.setPrimaryCategoryId(labelPO.getCategoryId());//lable表设计的categoryId是主大类id
    ...
    public PracticeSubjectListVO getSubjects(GetPracticeSubjectsReq req) {
        ...
        //TODO: 把pos里题目的id、type的集合set到vo里
