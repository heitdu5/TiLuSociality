        ...
        try {
            ...
            if (req.getReplyType() == 1) {
                ...
                LambdaQueryWrapper<ShareCommentReply> query = Wrappers.<ShareCommentReply>lambdaQuery()
                        .eq(ShareCommentReply::getId, req.getTargetId())//如果是回复，targetId就是评论Id
