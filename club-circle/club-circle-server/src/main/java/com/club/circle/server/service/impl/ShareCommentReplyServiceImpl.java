...
import com.club.circle.server.dao.ShareCommentReplyMapper;
import com.club.circle.server.dao.ShareMomentMapper;
import com.club.circle.server.entity.dto.UserInfo;
...
import com.club.circle.server.service.ShareCommentReplyService;
import com.club.circle.server.util.LoginUtil;
import com.club.circle.server.util.TreeUtils;
...
public class ShareCommentReplyServiceImpl extends ServiceImpl<ShareCommentReplyMapper, ShareCommentReply> implements ShareCommentReplyService {
    ...
    public List<ShareCommentReplyVO> listComment(GetShareCommentReq req) {
        ...
        UserInfo defaultUser = new UserInfo();//如果为空就使用这个默认的
